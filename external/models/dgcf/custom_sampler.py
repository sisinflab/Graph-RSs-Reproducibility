...
class Sampler:
    ...
    def sample_cor_samples(self, cor_batch_size):
        cor_users = random.sample(list(range(self._nusers)), cor_batch_size)
        cor_items = random.sample(list(range(self._nitems)), cor_batch_size)
